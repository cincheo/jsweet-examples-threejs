...
public class WebglInteractiveCubes {
	...
	public static void init() {
		...
		document.addEventListener(StringTypes.mousemove, WebglInteractiveCubes::onDocumentMouseMove, false);

		//

		window.addEventListener("resize", WebglInteractiveCubes::onWindowResize, false);
	...
	public static void animate(double time) {
		...
		requestAnimationFrame(WebglInteractiveCubes::animate);
